...
let id = 0;
const getId = () => `dndnode_${id++}`; // Function to generate unique IDs for nodes

function App() {
  // State management for nodes, edges, selected node, flow instance, save status, and node count
  ...
  return (
    <div>
      ...
      <div className="dndflow">
        ...
        {/* Node panel with draggable node */}
